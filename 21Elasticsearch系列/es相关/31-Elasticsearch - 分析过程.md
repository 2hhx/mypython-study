...
![image-20200310003447410](https://tva1.sinaimg.cn/large/00831rSTly1gco5c5qxnbj311v0u0ahk.jpg)
...
[停用词](https://baike.baidu.com/item/停用词/4531676)分析（stop analyzer）和简单分析器的行为很像，只是在分词流中额外的过滤了停用词。
